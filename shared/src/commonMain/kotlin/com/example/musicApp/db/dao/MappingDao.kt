...
class MappingDao(private val database: MelodistDatabase) {
    ...
    ) = com.example.musicApp.db.entities.AlbumEntity(
    ...
    fun artistsForSong(songId: String): List<com.example.musicApp.db.entities.ArtistEntity> {
    ...
    fun albumForSong(songId: String): com.example.musicApp.db.entities.AlbumEntity? {
