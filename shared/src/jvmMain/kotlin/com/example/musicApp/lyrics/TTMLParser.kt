...
/**
 * Parses Apple-Music-style TTML (word-synced lyrics) into timed lines/words and serializes them to
 * an enriched LRC string. Port of Metrolist's `betterlyrics/TTMLParser.kt`.
 *
 * Enriched LRC format produced by [toLRC]:
 *   `[mm:ss.cc]{tags}line text`
 *   `<word:startSeconds:endSeconds|word:startSeconds:endSeconds|…>`  (optional, follows its line)
 */
object TTMLParser {
