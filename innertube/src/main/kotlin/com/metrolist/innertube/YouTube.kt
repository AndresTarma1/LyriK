...
object YouTube {
    ...
    suspend fun playlist(playlistId: String): Result<PlaylistPage> = runCatching {
        ...
        val songCountInt = header?.secondSubtitle?.runs
        ?.firstOrNull { it.text.contains("pistas") }
        ?.text
    ...
    suspend fun libraryRecentActivity(filter: LibraryFilter = LibraryFilter.FILTER_RECENT_ACTIVITY): Result<LibraryPage> = runCatching {
        val continuation = filter.value
